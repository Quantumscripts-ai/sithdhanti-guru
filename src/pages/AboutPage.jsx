        ...
        <div className="container about-intro">
          ...
          <ScrollReveal delay={200}>
            <div className="about-intro__visuals">
              ...
              <img src="/images/attachments/IMG_0035.JPG" alt="Yoga practice" className="about-intro__img-main" />
              <img src="/images/attachments/IMG_0059.JPG" alt="Meditation" className="about-intro__img-sub" />
            </div>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="container founder-editorial">
          <ScrollReveal>
            <div className="founder-editorial__image-wrapper">
              ...
              <img src="/images/attachments/IMG_0060.JPG" alt="Dr. D. Uma Maheswari" className="founder-editorial__image" />
